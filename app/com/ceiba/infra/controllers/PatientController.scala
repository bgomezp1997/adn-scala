package com.ceiba.infra.controllers

import com.ceiba.infra.controllers.formatter.FormatterController
import com.ceiba.application.command.PatientCommand
import com.ceiba.application.command.patient.{CreatePatientDriver, DeletePatientDriver, UpgradePatientDriver}
import com.ceiba.application.consult.{ConsultPatientDriver, ListPatientDriver}
import com.ceiba.infra.util.ActionController._
