package com.ceiba.persistence.dao
...
import com.ceiba.model.table.Tables
...
class PatientDAOImpl @Inject() (val dbConfigProvider: DatabaseConfigProvider) extends PatientDAO with SlickDao with Tables {
  ...
  import com.ceiba.util.transformation.TransformationFuture._
  import com.ceiba.persistence.mapper.PatientDTOMapper._
